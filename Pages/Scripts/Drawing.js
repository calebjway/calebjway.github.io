...
function animateTest() {
        let Testx1=canvasTest.width/2+80*Math.sin(counter/Math.PI/4);
        let Testy1=canvasTest.height/2+80*Math.cos(counter/Math.PI/4);
        let Testx2=canvasTest.width/2+80*Math.sin(counter/Math.PI/4+Math.PI);
        let Testy2=canvasTest.height/2+80*Math.cos(counter/Math.PI/4+Math.PI);
